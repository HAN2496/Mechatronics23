...
#ifndef RTW_HEADER_problem1_2s_h_
#define RTW_HEADER_problem1_2s_h_
#include <math.h>
#include <float.h>
#include <string.h>
#include <stddef.h>
#ifndef problem1_2s_COMMON_INCLUDES_
#define problem1_2s_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "ext_work.h"
#include "MW_pigs.h"
#endif                                 /* problem1_2s_COMMON_INCLUDES_ */

#include "problem1_2s_types.h"
...
typedef struct {
  ...
  real_T LastUAtTimeA_k;               /* '<S4>/Derivative' */
  real_T TimeStampB_a;                 /* '<S4>/Derivative' */
...
struct P_problem1_2s_T_ {
  ...
  real_T IGain_Gain;                   /* Expression: 0.2
                                        ...
                                        */
  real_T DGain_Gain;                   /* Expression: 20
  ...
  real_T Constant1_Value;              /* Expression: 48
                                        ...
                                        */
  real_T PGain_Gain_c;                 /* Expression: 500
                                        * Referenced by: '<S4>/P Gain'
                                        */
  real_T Integrator_IC_h;              /* Expression: 0
                                        * Referenced by: '<S4>/Integrator'
                                        */
  real_T IGain_Gain_a;                 /* Expression: 0.2
                                        * Referenced by: '<S4>/I Gain'
                                        */
  real_T DGain_Gain_c;                 /* Expression: 20
...
struct tag_RTM_problem1_2s_T {
  const char_T *errorStatus;
  RTWExtModeInfo *extModeInfo;
  RTWSolverInfo solverInfo;
  X_problem1_2s_T *contStates;
...
extern P_problem1_2s_T problem1_2s_P;

/* Block signals (default storage) */
extern B_problem1_2s_T problem1_2s_B;

/* Continuous states (default storage) */
extern X_problem1_2s_T problem1_2s_X;

/* Block states (default storage) */
extern DW_problem1_2s_T problem1_2s_DW;

/* Model entry point functions */
extern void problem1_2s_initialize(void);
extern void problem1_2s_step(void);
extern void problem1_2s_terminate(void);

/* Real-time Model object */
extern RT_MODEL_problem1_2s_T *const problem1_2s_M;
 ...
 *
 * '<Root>' : 'problem1_2s'
 * '<S1>'   : 'problem1_2s/Motor Subsystem'
 * '<S2>'   : 'problem1_2s/Motor Subsystem1'
 * '<S3>'   : 'problem1_2s/PID Subsystem'
 * '<S4>'   : 'problem1_2s/PID Subsystem1'
 */
#endif                                 /* RTW_HEADER_problem1_2s_h_ */
