...
## 
## Makefile     : test1.mk
## Generated on : Mon Dec 04 22:10:31 2023
...
DEFINES_STANDARD = -DMODEL=test1 -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.cpp.o : $(START_DIR)/test1_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.c.o : $(START_DIR)/test1_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.c.o : $(START_DIR)/test1_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.c.o : $(START_DIR)/test1_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.c.o : $(START_DIR)/test1_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"


test1.c.o : $(START_DIR)/test1_ert_rtw/test1.c
	$(CC) $(CFLAGS) -o "$@" "$<"


test1_data.c.o : $(START_DIR)/test1_ert_rtw/test1_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
