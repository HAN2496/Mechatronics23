...
typedef struct {
  raspi_internal_PWMBlock_test1_T obj; /* '<Root>/PWM3' */
  raspi_internal_PWMBlock_test1_T obj_p;/* '<Root>/PWM2' */
  raspi_internal_PWMBlock_test1_T obj_e;/* '<Root>/PWM1' */
  raspi_internal_PWMBlock_test1_T obj_g;/* '<Root>/PWM' */
  ...
  real_T TimeStampA_l;                 /* '<S4>/Derivative' */
  real_T LastUAtTimeA_e;               /* '<S4>/Derivative' */
...
struct P_test1_T_ {
  ...
  real_T Integrator_IC;                /* Expression: 0
                                        ...
                                        */
  real_T IGain_Gain;                   /* Expression: 0.5
  ...
  real_T GPIO26Gain_Gain;              /* Expression: 1/100
                                        ...
                                        */
  real_T PGain_Gain_m;                 /* Expression: 500
                                        * Referenced by: '<S4>/P Gain'
                                        */
  real_T Integrator_IC_g;              /* Expression: 0
                                        * Referenced by: '<S4>/Integrator'
                                        */
  real_T IGain_Gain_k;                 /* Expression: 0.5
                                        * Referenced by: '<S4>/I Gain'
                                        */
  real_T DGain_Gain_o;                 /* Expression: 20
 ...
 *
 * '<Root>' : 'test1'
 * '<S1>'   : 'test1/Motor Subsystem'
 * '<S2>'   : 'test1/Motor Subsystem1'
 * '<S3>'   : 'test1/PID Subsystem'
 * '<S4>'   : 'test1/PID Subsystem1'
 */
