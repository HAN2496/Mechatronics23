###########################################################################
## Makefile generated for component 'check_maximum_acc'. 
## 
## Makefile     : check_maximum_acc.mk
## Generated on : Mon Dec 04 18:03:58 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/check_maximum_acc.elf
...
PRODUCT_NAME              = check_maximum_acc
MAKEFILE                  = check_maximum_acc.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/check_maximum_acc.elf
...
DEFINES_STANDARD = -DMODEL=check_maximum_acc -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.c.o : $(START_DIR)/check_maximum_acc_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/check_maximum_acc_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/check_maximum_acc_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.c.o : $(START_DIR)/check_maximum_acc_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


check_maximum_acc.c.o : $(START_DIR)/check_maximum_acc_ert_rtw/check_maximum_acc.c
	$(CC) $(CFLAGS) -o "$@" "$<"


check_maximum_acc_data.c.o : $(START_DIR)/check_maximum_acc_ert_rtw/check_maximum_acc_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
