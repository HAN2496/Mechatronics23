...
void final23_vcontrol_step(void)
{
...

  {
    ...
    rtb_DataTypeConversion = sMultiWord2Double(&final23_vcontrol_B.r.chunks[0U],
      2, 0) * 4.0389678347315804E-28;
    final23_vcontrol_MovingAverage(rtb_DataTypeConversion,
    ...
    if (rtmIsMajorTimeStep(final23_vcontrol_M)) {
      /* Delay: '<S6>/Delay' */
      final23_vcontrol_B.Delay_j = final23_vcontrol_DW.Delay_DSTATE_e;
    }
     ...
     *  Sum: '<S6>/Sum3'
     */
    final23_vcontrol_B.u = (uint64_T)final23_vcontrol_P.Gain_Gain_a;
    final23_vcontrol_B.u1 = (uint64_T)(final23_vcontrol_B.EncoderGain2 -
      final23_vcontrol_B.Delay_j);
    sMultiWordMul(&final23_vcontrol_B.u, 1, &final23_vcontrol_B.u1, 1,
                  &final23_vcontrol_B.r1.chunks[0U], 2);

    /* DataTypeConversion: '<S6>/Data Type Conversion' */
    rtb_DataTypeConversion_a = sMultiWord2Double(&final23_vcontrol_B.r1.chunks
      [0U], 2, 0) * 4.0389678347315804E-28;
    final23_vcontrol_MovingAverage(rtb_DataTypeConversion_a,
      &final23_vcontrol_B.MovingAverage_p, &final23_vcontrol_DW.MovingAverage_p);
    if (rtmIsMajorTimeStep(final23_vcontrol_M)) {
      /* FromWorkspace: '<Root>/From Workspace1' */
      {
        real_T *pDataValues = (real_T *)
          final23_vcontrol_DW.FromWorkspace1_PWORK.DataPtr;
        real_T *pTimeValues = (real_T *)
          final23_vcontrol_DW.FromWorkspace1_PWORK.TimePtr;
        int_T currTimeIndex = final23_vcontrol_DW.FromWorkspace1_IWORK.PrevIndex;
        real_T t = (((final23_vcontrol_M->Timing.clockTick1+
                      final23_vcontrol_M->Timing.clockTickH1* 4294967296.0)) *
                    0.001);
        ...
        final23_vcontrol_DW.FromWorkspace1_IWORK.PrevIndex = currTimeIndex;
        ...
        /* Post output */
        {
          ...
          if (t1 == t2) {
            if (t < t1) {
              final23_vcontrol_B.FromWorkspace1 = pDataValues[currTimeIndex];
            } else {
              final23_vcontrol_B.FromWorkspace1 = pDataValues[currTimeIndex + 1];
            }
          } else {
            real_T f1 = (t2 - t) / (t2 - t1);
            real_T f2 = 1.0 - f1;
            ...
            d1 = pDataValues[TimeIndex];
            d2 = pDataValues[TimeIndex + 1];
            final23_vcontrol_B.FromWorkspace1 = (real_T) rtInterpolate(d1, d2,
              f1, f2);
            pDataValues += 1481;
          }
        }
    ...
    /* Sum: '<Root>/Sum2' */
    final23_vcontrol_B.Sum2 = final23_vcontrol_B.FromWorkspace1 -
      final23_vcontrol_B.MovingAverage_p.MovingAverage;
  ...
  if (rtmIsMajorTimeStep(final23_vcontrol_M)) {
    ...
    *lastU = final23_vcontrol_B.Sum1;
    ...
    if (rtmIsMajorTimeStep(final23_vcontrol_M)) {
       ...
       *  Gain: '<Root>/Encoder Gain2'
       */
      final23_vcontrol_DW.Delay_DSTATE_e = final23_vcontrol_B.EncoderGain2;
    }
...
void final23_vcontrol_initialize(void)
{
  ...
  rtmSetTFinal(final23_vcontrol_M, 2.0);
  final23_vcontrol_M->Timing.stepSize0 = 0.001;

  /* External mode info */
        1.2409999999999999, 1.242, 1.2429999999999999, 1.244, 1.2449999999999997,
        1.246, 1.247, 1.248, 1.249, 1.25, 1.251, 1.252, 1.253, 1.254, 1.255,
        1.256, 1.257, 1.258, 1.259, 1.26, 1.261, 1.262, 1.263, 1.264, 1.265,
        1.266, 1.267, 1.268, 1.269, 1.27, 1.271, 1.272, 1.273, 1.274, 1.275,
        1.276, 1.277, 1.278, 1.279, 1.28, 1.281, 1.282, 1.283, 1.284, 1.285,
        1.286, 1.287, 1.288, 1.289, 1.29, 1.291, 1.292, 1.293, 1.294, 1.295,
        1.296, 1.297, 1.298, 1.299, 1.3, 1.301, 1.302, 1.303, 1.304, 1.305,
        1.306, 1.307, 1.308, 1.309, 1.31, 1.311, 1.312, 1.313, 1.314, 1.315,
        1.316, 1.317, 1.318, 1.319, 1.32, 1.321, 1.322, 1.323, 1.324, 1.325,
        1.326, 1.327, 1.328, 1.329, 1.33, 1.331, 1.332, 1.333, 1.334, 1.335,
        1.3359999999999999, 1.337, 1.338, 1.339, 1.3399999999999999, 1.341,
        1.342, 1.343, 1.3439999999999999, 1.345, 1.346, 1.347,
        ...
        1.361, 1.3619999999999999, 1.363, 1.3639999999999999, 1.365,
        1.3659999999999999, 1.367, 1.3679999999999999, 1.369, 1.3699999999999997,
        1.371, 1.372, 1.373, 1.374, 1.375, 1.376, 1.377, 1.378, 1.379, 1.38,
        1.381, 1.382, 1.383, 1.384, 1.385, 1.386, 1.387, 1.388, 1.389, 1.39,
        1.391, 1.392, 1.393, 1.394, 1.395, 1.396, 1.397, 1.398, 1.399, 1.4,
        1.401, 1.402, 1.403, 1.404, 1.405, 1.406, 1.407, 1.408, 1.409, 1.41,
        1.411, 1.412, 1.413, 1.414, 1.415, 1.416, 1.417, 1.418, 1.419, 1.42,
        1.421, 1.422, 1.423, 1.424, 1.425, 1.426, 1.427, 1.428, 1.429, 1.43,
        1.431, 1.432, 1.433, 1.434, 1.435, 1.436, 1.437, 1.438, 1.439, 1.44,
        1.441, 1.442, 1.443, 1.444, 1.445, 1.446, 1.447, 1.448, 1.449, 1.45,
        1.451, 1.452, 1.453, 1.454, 1.455, 1.456, 1.457, 1.458, 1.459, 1.46,
        1.461, 1.462, 1.463, 1.464, 1.465, 1.466, 1.467, 1.468, 1.469, 1.47,
        1.471, 1.472, 1.473, 1.474, 1.475, 1.476, 1.477, 1.478, 1.479, 1.48 } ;
      ...
      static real_T pDataValues0[] = { 2.1213203435596424, 2.1258155672156605,
        ...
        -2.1079541775359734, -2.1124776076253782, -2.1169915315691128 } ;
    ...
    final23_vco_MovingAverage_Start(&final23_vcontrol_DW.MovingAverage_p);
    ...
    /* Start for FromWorkspace: '<Root>/From Workspace1' */
    {
      ...
      static real_T pDataValues0[] = { -2.1213203435596433, -2.1168155739656589,
        ...
        2.1346028167808271, 2.1301263711999252, 2.1256403400539479 } ;

      final23_vcontrol_DW.FromWorkspace1_PWORK.TimePtr = (void *) pTimeValues0;
      final23_vcontrol_DW.FromWorkspace1_PWORK.DataPtr = (void *) pDataValues0;
      final23_vcontrol_DW.FromWorkspace1_IWORK.PrevIndex = 0;
    }
  ...
  final23_vcontrol_DW.Delay_DSTATE_e =
    final23_vcontrol_P.Delay_InitialCondition_o;
  ...
  final23_vcon_MovingAverage_Init(&final23_vcontrol_DW.MovingAverage_p);
}
...
void final23_vcontrol_terminate(void)
{
  ...
  final23_vcon_MovingAverage_Term(&final23_vcontrol_DW.MovingAverage_p);
