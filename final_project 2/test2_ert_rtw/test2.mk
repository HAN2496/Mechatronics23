...
## 
## Makefile     : test2.mk
## Generated on : Mon Dec 04 22:03:59 2023
...
%.c.o : $(START_DIR)/test2_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/test2_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/test2_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.c.o : $(START_DIR)/test2_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


test2.c.o : $(START_DIR)/test2_ert_rtw/test2.c
	$(CC) $(CFLAGS) -o "$@" "$<"


test2_data.c.o : $(START_DIR)/test2_ert_rtw/test2_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
