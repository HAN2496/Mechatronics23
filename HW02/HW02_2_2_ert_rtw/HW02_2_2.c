...
B_HW02_2_2_T HW02_2_2_B;

/* Continuous states */
X_HW02_2_2_T HW02_2_2_X;

/* Block states (default storage) */
DW_HW02_2_2_T HW02_2_2_DW;

/* Real-time model */
static RT_MODEL_HW02_2_2_T HW02_2_2_M_;
RT_MODEL_HW02_2_2_T *const HW02_2_2_M = &HW02_2_2_M_;
...
/* Model step function */
void HW02_2_2_step(void)
{
  if (rtmIsMajorTimeStep(HW02_2_2_M)) {
    /* set solver stop time */
    if (!(HW02_2_2_M->Timing.clockTick0+1)) {
      rtsiSetSolverStopTime(&HW02_2_2_M->solverInfo,
                            ((HW02_2_2_M->Timing.clockTickH0 + 1) *
        HW02_2_2_M->Timing.stepSize0 * 4294967296.0));
    } else {
      rtsiSetSolverStopTime(&HW02_2_2_M->solverInfo,
                            ((HW02_2_2_M->Timing.clockTick0 + 1) *
        HW02_2_2_M->Timing.stepSize0 + HW02_2_2_M->Timing.clockTickH0 *
        HW02_2_2_M->Timing.stepSize0 * 4294967296.0));
    }
  }                                    /* end MajorTimeStep */

  /* Update absolute time of base rate at minor time step */
  if (rtmIsMinorTimeStep(HW02_2_2_M)) {
    HW02_2_2_M->Timing.t[0] = rtsiGetT(&HW02_2_2_M->solverInfo);
  }

  {
    ...
    Quad_Encoder_sfn_Outputs_wrapper(&HW02_2_2_B.QuadEncoder2axis_o1,
      &HW02_2_2_B.QuadEncoder2axis_o2, &HW02_2_2_DW.QuadEncoder2axis_DSTATE,
      &HW02_2_2_P.QuadEncoder2axis_P1, 1, &HW02_2_2_P.QuadEncoder2axis_P2, 1,
      &HW02_2_2_P.QuadEncoder2axis_P3, 1, &HW02_2_2_P.QuadEncoder2axis_P4, 1,
      &HW02_2_2_P.QuadEncoder2axis_P5, 1, &HW02_2_2_P.QuadEncoder2axis_P6, 1);

    /* Gain: '<Root>/Encoder Gain1' */
    HW02_2_2_B.EncoderGain1 = (int64_T)HW02_2_2_P.EncoderGain1_Gain *
      HW02_2_2_B.QuadEncoder2axis_o1;

    /* Sum: '<Root>/Sum1' incorporates:
     *  Constant: '<Root>/Constant'
     *  Gain: '<Root>/Encoder Gain1'
     */
    HW02_2_2_B.Sum1 = HW02_2_2_P.Constant_Value - (real_T)
      HW02_2_2_B.EncoderGain1 * 3.637978807091713E-12;

    /* Derivative: '<S3>/Derivative' incorporates:
     *  Derivative: '<S4>/Derivative'
     */
    rtb_Sum_i = HW02_2_2_M->Timing.t[0];
    if ((HW02_2_2_DW.TimeStampA >= rtb_Sum_i) && (HW02_2_2_DW.TimeStampB >=
         rtb_Sum_i)) {
      rtb_Switch = 0.0;
    } else {
      rtb_Switch = HW02_2_2_DW.TimeStampA;
      lastU = &HW02_2_2_DW.LastUAtTimeA;
      if (HW02_2_2_DW.TimeStampA < HW02_2_2_DW.TimeStampB) {
        if (HW02_2_2_DW.TimeStampB < rtb_Sum_i) {
          rtb_Switch = HW02_2_2_DW.TimeStampB;
          lastU = &HW02_2_2_DW.LastUAtTimeB;
        }
      } else if (HW02_2_2_DW.TimeStampA >= rtb_Sum_i) {
        rtb_Switch = HW02_2_2_DW.TimeStampB;
        lastU = &HW02_2_2_DW.LastUAtTimeB;
      }

      rtb_Switch = (HW02_2_2_B.Sum1 - *lastU) / (rtb_Sum_i - rtb_Switch);
    }
     ...
     */
    rtb_Sum = (HW02_2_2_P.PGain_Gain * HW02_2_2_B.Sum1 + HW02_2_2_P.IGain_Gain *
               HW02_2_2_X.Integrator_CSTATE) + HW02_2_2_P.DGain_Gain *
      rtb_Switch;

    /* Switch: '<S1>/Switch1' incorporates:
     *  Constant: '<S1>/Constant'
     */
    if (rtb_Sum > HW02_2_2_P.Switch1_Threshold) {
      rtb_Switch = rtb_Sum;
    } else {
      rtb_Switch = HW02_2_2_P.Constant_Value_d;
    }

    /* End of Switch: '<S1>/Switch1' */

    /* Gain: '<S1>/GPIO19 Gain' */
    rtb_Switch *= HW02_2_2_P.GPIO19Gain_Gain;
    ...
    EXT_PWMBlock_setDutyCycle(HW02_2_2_DW.obj_g.PinNumber, rtb_Switch);
     ...
     *  Constant: '<S1>/Constant'
     */
    if (rtb_Sum > HW02_2_2_P.Switch_Threshold) {
      rtb_Sum = HW02_2_2_P.Constant_Value_d;
    } else {
    ...
    /* Gain: '<S1>/GPIO26 Gain' */
    rtb_Switch = HW02_2_2_P.GPIO26Gain_Gain * rtb_Sum;
    ...
    EXT_PWMBlock_setDutyCycle(HW02_2_2_DW.obj_e.PinNumber, rtb_Switch);
    ...
    HW02_2_2_B.EncoderGain2 = (int64_T)HW02_2_2_P.EncoderGain2_Gain *
      HW02_2_2_B.QuadEncoder2axis_o2;

    /* Sum: '<Root>/Sum2' incorporates:
     *  Constant: '<Root>/Constant'
     *  Gain: '<Root>/Encoder Gain2'
     */
    HW02_2_2_B.Sum2 = HW02_2_2_P.Constant_Value - (real_T)
      HW02_2_2_B.EncoderGain2 * 3.637978807091713E-12;

    /* Derivative: '<S4>/Derivative' */
    if ((HW02_2_2_DW.TimeStampA_a >= rtb_Sum_i) && (HW02_2_2_DW.TimeStampB_o >=
         rtb_Sum_i)) {
      rtb_Switch = 0.0;
    } else {
      rtb_Switch = HW02_2_2_DW.TimeStampA_a;
      lastU = &HW02_2_2_DW.LastUAtTimeA_i;
      if (HW02_2_2_DW.TimeStampA_a < HW02_2_2_DW.TimeStampB_o) {
        if (HW02_2_2_DW.TimeStampB_o < rtb_Sum_i) {
          rtb_Switch = HW02_2_2_DW.TimeStampB_o;
          lastU = &HW02_2_2_DW.LastUAtTimeB_m;
        }
      } else if (HW02_2_2_DW.TimeStampA_a >= rtb_Sum_i) {
        rtb_Switch = HW02_2_2_DW.TimeStampB_o;
        lastU = &HW02_2_2_DW.LastUAtTimeB_m;
      }

      rtb_Switch = (HW02_2_2_B.Sum2 - *lastU) / (rtb_Sum_i - rtb_Switch);
    }
     ...
     */
    rtb_Sum_i = (HW02_2_2_P.PGain_Gain_i * HW02_2_2_B.Sum2 +
                 HW02_2_2_P.IGain_Gain_j * HW02_2_2_X.Integrator_CSTATE_l) +
      HW02_2_2_P.DGain_Gain_h * rtb_Switch;

    /* Switch: '<S2>/Switch1' incorporates:
     *  Constant: '<S2>/Constant'
     */
    if (rtb_Sum_i > HW02_2_2_P.Switch1_Threshold_c) {
      rtb_Switch = rtb_Sum_i;
    } else {
      rtb_Switch = HW02_2_2_P.Constant_Value_e;
    }

    /* End of Switch: '<S2>/Switch1' */

    /* Gain: '<S2>/GPIO20 Gain' */
    rtb_Switch *= HW02_2_2_P.GPIO20Gain_Gain;
    ...
    EXT_PWMBlock_setDutyCycle(HW02_2_2_DW.obj_p.PinNumber, rtb_Switch);
     ...
     *  Constant: '<S2>/Constant'
     */
    if (rtb_Sum_i > HW02_2_2_P.Switch_Threshold_m) {
      rtb_Sum_i = HW02_2_2_P.Constant_Value_e;
    } else {
      rtb_Sum_i = fabs(rtb_Sum_i);
    }

    /* End of Switch: '<S2>/Switch' */

    /* Gain: '<S2>/GPIO21 Gain' */
    rtb_Switch = HW02_2_2_P.GPIO21Gain_Gain * rtb_Sum_i;
    ...
    EXT_PWMBlock_setDutyCycle(HW02_2_2_DW.obj.PinNumber, rtb_Switch);

    /* End of MATLABSystem: '<Root>/PWM3' */
    if (rtmIsMajorTimeStep(HW02_2_2_M)) {
      /* FromWorkspace: '<Root>/From Workspace' */
      {
        real_T *pDataValues = (real_T *) HW02_2_2_DW.FromWorkspace_PWORK.DataPtr;
        real_T *pTimeValues = (real_T *) HW02_2_2_DW.FromWorkspace_PWORK.TimePtr;
        int_T currTimeIndex = HW02_2_2_DW.FromWorkspace_IWORK.PrevIndex;
        real_T t = (((HW02_2_2_M->Timing.clockTick1+
                      HW02_2_2_M->Timing.clockTickH1* 4294967296.0)) * 0.001);
        ...
        HW02_2_2_DW.FromWorkspace_IWORK.PrevIndex = currTimeIndex;
        ...
        /* Post output */
        {
          ...
          if (t1 == t2) {
            if (t < t1) {
              HW02_2_2_B.FromWorkspace = pDataValues[currTimeIndex];
            } else {
              HW02_2_2_B.FromWorkspace = pDataValues[currTimeIndex + 1];
            }
          } else {
            ...
            HW02_2_2_B.FromWorkspace = (real_T) rtInterpolate(d1, d2, f1, f2);
            pDataValues += 10001;
          }
        }
      }
  ...
  if (rtmIsMajorTimeStep(HW02_2_2_M)) {
    ...
    Quad_Encoder_sfn_Update_wrapper(&HW02_2_2_B.QuadEncoder2axis_o1,
      &HW02_2_2_B.QuadEncoder2axis_o2, &HW02_2_2_DW.QuadEncoder2axis_DSTATE,
      &HW02_2_2_P.QuadEncoder2axis_P1, 1, &HW02_2_2_P.QuadEncoder2axis_P2, 1,
      &HW02_2_2_P.QuadEncoder2axis_P3, 1, &HW02_2_2_P.QuadEncoder2axis_P4, 1,
      &HW02_2_2_P.QuadEncoder2axis_P5, 1, &HW02_2_2_P.QuadEncoder2axis_P6, 1);
    ...
    if (HW02_2_2_DW.TimeStampA == (rtInf)) {
      HW02_2_2_DW.TimeStampA = HW02_2_2_M->Timing.t[0];
      lastU = &HW02_2_2_DW.LastUAtTimeA;
    } else if (HW02_2_2_DW.TimeStampB == (rtInf)) {
      HW02_2_2_DW.TimeStampB = HW02_2_2_M->Timing.t[0];
      lastU = &HW02_2_2_DW.LastUAtTimeB;
    } else if (HW02_2_2_DW.TimeStampA < HW02_2_2_DW.TimeStampB) {
      HW02_2_2_DW.TimeStampA = HW02_2_2_M->Timing.t[0];
      lastU = &HW02_2_2_DW.LastUAtTimeA;
    } else {
      HW02_2_2_DW.TimeStampB = HW02_2_2_M->Timing.t[0];
    ...
    *lastU = HW02_2_2_B.Sum1;

    /* End of Update for Derivative: '<S3>/Derivative' */

    /* Update for Derivative: '<S4>/Derivative' */
    if (HW02_2_2_DW.TimeStampA_a == (rtInf)) {
      HW02_2_2_DW.TimeStampA_a = HW02_2_2_M->Timing.t[0];
      lastU = &HW02_2_2_DW.LastUAtTimeA_i;
    } else if (HW02_2_2_DW.TimeStampB_o == (rtInf)) {
      HW02_2_2_DW.TimeStampB_o = HW02_2_2_M->Timing.t[0];
      lastU = &HW02_2_2_DW.LastUAtTimeB_m;
    } else if (HW02_2_2_DW.TimeStampA_a < HW02_2_2_DW.TimeStampB_o) {
      HW02_2_2_DW.TimeStampA_a = HW02_2_2_M->Timing.t[0];
      lastU = &HW02_2_2_DW.LastUAtTimeA_i;
    } else {
      HW02_2_2_DW.TimeStampB_o = HW02_2_2_M->Timing.t[0];
    ...
    *lastU = HW02_2_2_B.Sum2;
    ...
    {                                  /* Sample time: [0.0s, 0.0s] */
      rtExtModeUpload(0, (real_T)HW02_2_2_M->Timing.t[0]);
    }

    if (rtmIsMajorTimeStep(HW02_2_2_M)) {/* Sample time: [0.001s, 0.0s] */
      rtExtModeUpload(1, (real_T)(((HW02_2_2_M->Timing.clockTick1+
        HW02_2_2_M->Timing.clockTickH1* 4294967296.0)) * 0.001));
    }
  }                                    /* end MajorTimeStep */
  ...
  if (rtmIsMajorTimeStep(HW02_2_2_M)) {
    ...
    {                                  /* Sample time: [0.0s, 0.0s] */
      if ((rtmGetTFinal(HW02_2_2_M)!=-1) &&
          !((rtmGetTFinal(HW02_2_2_M)-(((HW02_2_2_M->Timing.clockTick1+
               HW02_2_2_M->Timing.clockTickH1* 4294967296.0)) * 0.001)) >
            (((HW02_2_2_M->Timing.clockTick1+HW02_2_2_M->Timing.clockTickH1*
               4294967296.0)) * 0.001) * (DBL_EPSILON))) {
        rtmSetErrorStatus(HW02_2_2_M, "Simulation finished");
      }

      if (rtmGetStopRequested(HW02_2_2_M)) {
        rtmSetErrorStatus(HW02_2_2_M, "Simulation finished");
      }
    }

    rt_ertODEUpdateContinuousStates(&HW02_2_2_M->solverInfo);
     ...
     */
    if (!(++HW02_2_2_M->Timing.clockTick0)) {
      ++HW02_2_2_M->Timing.clockTickH0;
    }

    HW02_2_2_M->Timing.t[0] = rtsiGetSolverStopTime(&HW02_2_2_M->solverInfo);

    {
       ...
       */
      HW02_2_2_M->Timing.clockTick1++;
      if (!HW02_2_2_M->Timing.clockTick1) {
        HW02_2_2_M->Timing.clockTickH1++;
      }
    }
  }                                    /* end MajorTimeStep */
}
...
void HW02_2_2_derivatives(void)
{
  XDot_HW02_2_2_T *_rtXdot;
  _rtXdot = ((XDot_HW02_2_2_T *) HW02_2_2_M->derivs);

  /* Derivatives for Integrator: '<S3>/Integrator' */
  _rtXdot->Integrator_CSTATE = HW02_2_2_B.Sum1;

  /* Derivatives for Integrator: '<S4>/Integrator' */
  _rtXdot->Integrator_CSTATE_l = HW02_2_2_B.Sum2;
}

/* Model initialize function */
void HW02_2_2_initialize(void)
{
  /* Registration code */
  ...
  (void) memset((void *)HW02_2_2_M, 0,
                sizeof(RT_MODEL_HW02_2_2_T));

  {
    /* Setup solver object */
    rtsiSetSimTimeStepPtr(&HW02_2_2_M->solverInfo,
                          &HW02_2_2_M->Timing.simTimeStep);
    rtsiSetTPtr(&HW02_2_2_M->solverInfo, &rtmGetTPtr(HW02_2_2_M));
    rtsiSetStepSizePtr(&HW02_2_2_M->solverInfo, &HW02_2_2_M->Timing.stepSize0);
    rtsiSetdXPtr(&HW02_2_2_M->solverInfo, &HW02_2_2_M->derivs);
    rtsiSetContStatesPtr(&HW02_2_2_M->solverInfo, (real_T **)
                         &HW02_2_2_M->contStates);
    rtsiSetNumContStatesPtr(&HW02_2_2_M->solverInfo,
      &HW02_2_2_M->Sizes.numContStates);
    rtsiSetNumPeriodicContStatesPtr(&HW02_2_2_M->solverInfo,
      &HW02_2_2_M->Sizes.numPeriodicContStates);
    rtsiSetPeriodicContStateIndicesPtr(&HW02_2_2_M->solverInfo,
      &HW02_2_2_M->periodicContStateIndices);
    rtsiSetPeriodicContStateRangesPtr(&HW02_2_2_M->solverInfo,
      &HW02_2_2_M->periodicContStateRanges);
    rtsiSetErrorStatusPtr(&HW02_2_2_M->solverInfo, (&rtmGetErrorStatus
      (HW02_2_2_M)));
    rtsiSetRTModelPtr(&HW02_2_2_M->solverInfo, HW02_2_2_M);
  }

  rtsiSetSimTimeStep(&HW02_2_2_M->solverInfo, MAJOR_TIME_STEP);
  HW02_2_2_M->intgData.y = HW02_2_2_M->odeY;
  HW02_2_2_M->intgData.f[0] = HW02_2_2_M->odeF[0];
  HW02_2_2_M->intgData.f[1] = HW02_2_2_M->odeF[1];
  HW02_2_2_M->intgData.f[2] = HW02_2_2_M->odeF[2];
  HW02_2_2_M->contStates = ((X_HW02_2_2_T *) &HW02_2_2_X);
  rtsiSetSolverData(&HW02_2_2_M->solverInfo, (void *)&HW02_2_2_M->intgData);
  rtsiSetSolverName(&HW02_2_2_M->solverInfo,"ode3");
  rtmSetTPtr(HW02_2_2_M, &HW02_2_2_M->Timing.tArray[0]);
  rtmSetTFinal(HW02_2_2_M, -1);
  HW02_2_2_M->Timing.stepSize0 = 0.001;

  /* External mode info */
  HW02_2_2_M->Sizes.checksums[0] = (1171736372U);
  HW02_2_2_M->Sizes.checksums[1] = (1815862263U);
  HW02_2_2_M->Sizes.checksums[2] = (3433190811U);
  HW02_2_2_M->Sizes.checksums[3] = (3637611582U);

  {
    static const sysRanDType rtAlwaysEnabled = SUBSYS_RAN_BC_ENABLE;
    static RTWExtModeInfo rt_ExtModeInfo;
    static const sysRanDType *systemRan[7];
    HW02_2_2_M->extModeInfo = (&rt_ExtModeInfo);
    ...
    rteiSetModelMappingInfoPtr(HW02_2_2_M->extModeInfo,
      &HW02_2_2_M->SpecialInfo.mappingInfo);
    rteiSetChecksumsPtr(HW02_2_2_M->extModeInfo, HW02_2_2_M->Sizes.checksums);
    rteiSetTPtr(HW02_2_2_M->extModeInfo, rtmGetTPtr(HW02_2_2_M));
  }

  /* block I/O */
  (void) memset(((void *) &HW02_2_2_B), 0,
                sizeof(B_HW02_2_2_T));

  {
    HW02_2_2_B.EncoderGain1 = (0LL);
    HW02_2_2_B.EncoderGain2 = (0LL);
  }

  /* states (continuous) */
  {
    (void) memset((void *)&HW02_2_2_X, 0,
                  sizeof(X_HW02_2_2_T));
  }

  /* states (dwork) */
  (void) memset((void *)&HW02_2_2_DW, 0,
                sizeof(DW_HW02_2_2_T));

  {
    ...
    Quad_Encoder_sfn_Start_wrapper(&HW02_2_2_DW.QuadEncoder2axis_DSTATE,
      &HW02_2_2_P.QuadEncoder2axis_P1, 1, &HW02_2_2_P.QuadEncoder2axis_P2, 1,
      &HW02_2_2_P.QuadEncoder2axis_P3, 1, &HW02_2_2_P.QuadEncoder2axis_P4, 1,
      &HW02_2_2_P.QuadEncoder2axis_P5, 1, &HW02_2_2_P.QuadEncoder2axis_P6, 1);

    /* Start for MATLABSystem: '<Root>/PWM' */
    HW02_2_2_DW.obj_g.matlabCodegenIsDeleted = false;
    HW02_2_2_DW.objisempty_l = true;
    HW02_2_2_DW.obj_g.isInitialized = 1;
    HW02_2_2_DW.obj_g.PinNumber = 19U;
    ret = EXT_PWMBlock_init(HW02_2_2_DW.obj_g.PinNumber, 1000U, 0.0);
    if (ret != 0) {
      for (ret = 0; ret < 45; ret++) {
        b[ret] = tmp[ret];
      }

      printf(&b[0], HW02_2_2_DW.obj_g.PinNumber);
    }

    HW02_2_2_DW.obj_g.isSetupComplete = true;

    /* End of Start for MATLABSystem: '<Root>/PWM' */

    /* Start for MATLABSystem: '<Root>/PWM1' */
    HW02_2_2_DW.obj_e.matlabCodegenIsDeleted = false;
    HW02_2_2_DW.objisempty_p = true;
    HW02_2_2_DW.obj_e.isInitialized = 1;
    HW02_2_2_DW.obj_e.PinNumber = 26U;
    ret = EXT_PWMBlock_init(HW02_2_2_DW.obj_e.PinNumber, 1000U, 0.0);
    if (ret != 0) {
      for (ret = 0; ret < 45; ret++) {
        b[ret] = tmp[ret];
      }

      printf(&b[0], HW02_2_2_DW.obj_e.PinNumber);
    }

    HW02_2_2_DW.obj_e.isSetupComplete = true;

    /* End of Start for MATLABSystem: '<Root>/PWM1' */
    /* Start for MATLABSystem: '<Root>/PWM2' */
    HW02_2_2_DW.obj_p.matlabCodegenIsDeleted = false;
    HW02_2_2_DW.objisempty_d = true;
    HW02_2_2_DW.obj_p.isInitialized = 1;
    HW02_2_2_DW.obj_p.PinNumber = 20U;
    ret = EXT_PWMBlock_init(HW02_2_2_DW.obj_p.PinNumber, 1000U, 0.0);
    if (ret != 0) {
      for (ret = 0; ret < 45; ret++) {
        b[ret] = tmp[ret];
      }

      printf(&b[0], HW02_2_2_DW.obj_p.PinNumber);
    }

    HW02_2_2_DW.obj_p.isSetupComplete = true;

    /* End of Start for MATLABSystem: '<Root>/PWM2' */

    /* Start for MATLABSystem: '<Root>/PWM3' */
    HW02_2_2_DW.obj.matlabCodegenIsDeleted = false;
    HW02_2_2_DW.objisempty = true;
    HW02_2_2_DW.obj.isInitialized = 1;
    HW02_2_2_DW.obj.PinNumber = 21U;
    ret = EXT_PWMBlock_init(HW02_2_2_DW.obj.PinNumber, 1000U, 0.0);
    if (ret != 0) {
      for (ret = 0; ret < 45; ret++) {
        b[ret] = tmp[ret];
      }

      printf(&b[0], HW02_2_2_DW.obj.PinNumber);
    }

    HW02_2_2_DW.obj.isSetupComplete = true;
    ...
    /* Start for FromWorkspace: '<Root>/From Workspace' */
    {
      ...
      HW02_2_2_DW.FromWorkspace_PWORK.TimePtr = (void *) pTimeValues0;
      HW02_2_2_DW.FromWorkspace_PWORK.DataPtr = (void *) pDataValues0;
      HW02_2_2_DW.FromWorkspace_IWORK.PrevIndex = 0;
    }
  }
  ...
  /* S-Function Block: <Root>/Quad Encoder 2axis */
  {
...

    {
      int_T i1;
      for (i1=0; i1 < 1; i1++) {
        HW02_2_2_DW.QuadEncoder2axis_DSTATE = initVector[0];
      }
    }
  }

  /* InitializeConditions for Integrator: '<S3>/Integrator' */
  HW02_2_2_X.Integrator_CSTATE = HW02_2_2_P.Integrator_IC;

  /* InitializeConditions for Derivative: '<S3>/Derivative' */
  HW02_2_2_DW.TimeStampA = (rtInf);
  HW02_2_2_DW.TimeStampB = (rtInf);

  /* InitializeConditions for Integrator: '<S4>/Integrator' */
  HW02_2_2_X.Integrator_CSTATE_l = HW02_2_2_P.Integrator_IC_m;

  /* InitializeConditions for Derivative: '<S4>/Derivative' */
  HW02_2_2_DW.TimeStampA_a = (rtInf);
  HW02_2_2_DW.TimeStampB_o = (rtInf);
}

/* Model terminate function */
void HW02_2_2_terminate(void)
{
  /* Terminate for S-Function (Quad_Encoder_sfn): '<Root>/Quad Encoder 2axis' */

  /* S-Function Block: <Root>/Quad Encoder 2axis */
  Quad_Encoder_sfn_Terminate_wrapper(&HW02_2_2_DW.QuadEncoder2axis_DSTATE,
    &HW02_2_2_P.QuadEncoder2axis_P1, 1, &HW02_2_2_P.QuadEncoder2axis_P2, 1,
    &HW02_2_2_P.QuadEncoder2axis_P3, 1, &HW02_2_2_P.QuadEncoder2axis_P4, 1,
    &HW02_2_2_P.QuadEncoder2axis_P5, 1, &HW02_2_2_P.QuadEncoder2axis_P6, 1);

  /* Terminate for MATLABSystem: '<Root>/PWM' */
  if (!HW02_2_2_DW.obj_g.matlabCodegenIsDeleted) {
    HW02_2_2_DW.obj_g.matlabCodegenIsDeleted = true;
    if ((HW02_2_2_DW.obj_g.isInitialized == 1) &&
        HW02_2_2_DW.obj_g.isSetupComplete) {
      EXT_PWMBlock_terminate(HW02_2_2_DW.obj_g.PinNumber);
    }
  }
  ...
  if (!HW02_2_2_DW.obj_e.matlabCodegenIsDeleted) {
    HW02_2_2_DW.obj_e.matlabCodegenIsDeleted = true;
    if ((HW02_2_2_DW.obj_e.isInitialized == 1) &&
        HW02_2_2_DW.obj_e.isSetupComplete) {
      EXT_PWMBlock_terminate(HW02_2_2_DW.obj_e.PinNumber);
    }
  }

  /* End of Terminate for MATLABSystem: '<Root>/PWM1' */
  /* Terminate for MATLABSystem: '<Root>/PWM2' */
  if (!HW02_2_2_DW.obj_p.matlabCodegenIsDeleted) {
    HW02_2_2_DW.obj_p.matlabCodegenIsDeleted = true;
    if ((HW02_2_2_DW.obj_p.isInitialized == 1) &&
        HW02_2_2_DW.obj_p.isSetupComplete) {
      EXT_PWMBlock_terminate(HW02_2_2_DW.obj_p.PinNumber);
    }
  }
  ...
  if (!HW02_2_2_DW.obj.matlabCodegenIsDeleted) {
    HW02_2_2_DW.obj.matlabCodegenIsDeleted = true;
    if ((HW02_2_2_DW.obj.isInitialized == 1) && HW02_2_2_DW.obj.isSetupComplete)
    {
      EXT_PWMBlock_terminate(HW02_2_2_DW.obj.PinNumber);
    }
  }
