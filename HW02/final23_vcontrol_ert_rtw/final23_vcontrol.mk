###########################################################################
## Makefile generated for component 'final23_vcontrol'. 
## 
## Makefile     : final23_vcontrol.mk
## Generated on : Mon Dec 04 17:46:53 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/final23_vcontrol.elf
...
START_DIR                 = $(MATLAB_WORKSPACE)/C/mecha/Mechatronics23/HW02
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
LDFLAGS = -lrt -lpthread -ldl -lwiringPi -g
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/final23_vcontrol.elf
...
DEFINES_ = -DMW_PWMBLOCK -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__
...
DEFINES_CUSTOM = 
DEFINES_OPTS = -DXCP_DAQ_SUPPORT -DXCP_CALIBRATION_SUPPORT -DXCP_TIMESTAMP_SUPPORT -DXCP_TIMESTAMP_BASED_ON_SIMULATION_TIME -DXCP_SET_MTA_SUPPORT -DXCP_MEM_DAQ_RESERVED_POOLS_NUMBER=2 -DEXTMODE_XCP_TRIGGER_SUPPORT -DEXTMODE_STATIC -DEXTMODE_STATIC_SIZE=1000000 -DON_TARGET_WAIT_FOR_START=1 -DTID01EQ=1
DEFINES_SKIPFORSIL = -D__linux__ -DARM_PROJECT -D_USE_TARGET_UDP_ -D_RUNONTARGETHARDWARE_BUILD_ -DSTACK_SIZE=64 -DRT
DEFINES_STANDARD = -DMODEL=final23_vcontrol -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.c.o : $(MATLAB_WORKSPACE)/C/CM_Projects/Mechatronics23/HW02/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(MATLAB_WORKSPACE)/C/CM_Projects/Mechatronics23/HW02/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(MATLAB_WORKSPACE)/C/CM_Projects/Mechatronics23/HW02/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.c.o : $(START_DIR)/final23_vcontrol_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/final23_vcontrol_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/final23_vcontrol_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
MW_pigs.c.o : $(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/realtime/targets/raspi/unifiedserver/MW_pigs.c
	$(CC) $(CFLAGS) -o "$@" "$<"


system.c.o : $(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/realtime/targets/raspi/unifiedserver/system.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.c.o : $(START_DIR)/final23_vcontrol_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


final23_vcontrol.c.o : $(START_DIR)/final23_vcontrol_ert_rtw/final23_vcontrol.c
	$(CC) $(CFLAGS) -o "$@" "$<"


final23_vcontrol_data.c.o : $(START_DIR)/final23_vcontrol_ert_rtw/final23_vcontrol_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.c.o : $(START_DIR)/final23_vcontrol_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.c.o : $(START_DIR)/final23_vcontrol_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.c.o : $(START_DIR)/final23_vcontrol_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
