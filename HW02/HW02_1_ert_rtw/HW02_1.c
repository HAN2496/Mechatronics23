 ...
 * C source code generated on : Mon Dec  4 16:38:46 2023
 *
...
void HW02_1_step(void)
{
  ...
  /* Gain: '<Root>/Gain' */
  HW02_1_B.Gain = (int64_T)HW02_1_P.Gain_Gain * HW02_1_B.QuadEncoder2axis_o2;
  ...
  if (HW02_1_DW.RateTransition1_write_buf != 0) {
    HW02_1_DW.RateTransition1_Buffer1 = HW02_1_B.Gain;
  } else {
    HW02_1_DW.RateTransition1_Buffer0 = HW02_1_B.Gain;
  }
...
void HW02_1_initialize(void)
{
  ...
  rtmSetTFinal(HW02_1_M, 10.0);
  HW02_1_M->Timing.stepSize0 = 0.001;

  /* External mode info */
  HW02_1_M->Sizes.checksums[0] = (2541002570U);
  HW02_1_M->Sizes.checksums[1] = (3115902934U);
  HW02_1_M->Sizes.checksums[2] = (3403030797U);
  HW02_1_M->Sizes.checksums[3] = (3658561235U);
