...
## Generated on : Thu Dec 14 22:29:34 2023
...
PRODUCT_NAME              = final23_poscontrol
MAKEFILE                  = final23_poscontrol.mk
...
START_DIR                 = $(MATLAB_WORKSPACE)/C/mecha/Mechatronics23/final_report
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/final23_poscontrol.elf
...
DEFINES_STANDARD = -DMODEL=final23_poscontrol -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.c.o : $(START_DIR)/final23_poscontrol_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/final23_poscontrol_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/final23_poscontrol_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.c.o : $(START_DIR)/final23_poscontrol_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


final23_poscontrol.c.o : $(START_DIR)/final23_poscontrol_ert_rtw/final23_poscontrol.c
	$(CC) $(CFLAGS) -o "$@" "$<"


final23_poscontrol_data.c.o : $(START_DIR)/final23_poscontrol_ert_rtw/final23_poscontrol_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.c.o : $(START_DIR)/final23_poscontrol_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.c.o : $(START_DIR)/final23_poscontrol_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.c.o : $(START_DIR)/final23_poscontrol_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
