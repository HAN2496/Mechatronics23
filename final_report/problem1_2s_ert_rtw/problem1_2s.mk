###########################################################################
## Makefile generated for component 'problem1_2s'. 
## 
## Makefile     : problem1_2s.mk
## Generated on : Mon Dec 11 18:14:13 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/problem1_2s.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/problem1_2s.elf
...
DEFINES_STANDARD = -DMODEL=problem1_2s -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.c.o : $(START_DIR)/problem1_2s_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/problem1_2s_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/problem1_2s_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.c.o : $(START_DIR)/problem1_2s_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


problem1_2s.c.o : $(START_DIR)/problem1_2s_ert_rtw/problem1_2s.c
	$(CC) $(CFLAGS) -o "$@" "$<"


problem1_2s_data.c.o : $(START_DIR)/problem1_2s_ert_rtw/problem1_2s_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.c.o : $(START_DIR)/problem1_2s_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.c.o : $(START_DIR)/problem1_2s_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.c.o : $(START_DIR)/problem1_2s_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
