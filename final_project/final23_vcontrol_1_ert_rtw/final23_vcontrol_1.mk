###########################################################################
## Makefile generated for component 'final23_vcontrol_1'. 
## 
## Makefile     : final23_vcontrol_1.mk
## Generated on : Mon Dec 04 21:11:38 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/final23_vcontrol_1.elf
...
PRODUCT_NAME              = final23_vcontrol_1
MAKEFILE                  = final23_vcontrol_1.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/final23_vcontrol_1.elf
...
DEFINES_STANDARD = -DMODEL=final23_vcontrol_1 -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.c.o : $(START_DIR)/final23_vcontrol_1_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/final23_vcontrol_1_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/final23_vcontrol_1_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.c.o : $(START_DIR)/final23_vcontrol_1_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


final23_vcontrol_1.c.o : $(START_DIR)/final23_vcontrol_1_ert_rtw/final23_vcontrol_1.c
	$(CC) $(CFLAGS) -o "$@" "$<"


final23_vcontrol_1_data.c.o : $(START_DIR)/final23_vcontrol_1_ert_rtw/final23_vcontrol_1_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.c.o : $(START_DIR)/final23_vcontrol_1_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.c.o : $(START_DIR)/final23_vcontrol_1_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.c.o : $(START_DIR)/final23_vcontrol_1_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
